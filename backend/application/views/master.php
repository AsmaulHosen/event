...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Event manager pro</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li>
                        <button type="button" class="btn btn-primary" data-toggle="modal" style="margin-top: 5px;" data-target="#exampleModal">
                            Join as vendor
                        </button>
                    </li>
                </ul>
                        ...
                        <div class="tab-pane" role="tabpanel" id="register">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Type your First Name" aria-describedby="emailHelp">

                                </div>
                                <div class="form-group">
                                    <label for="inputname">Last name</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Type your Last Name" aria-describedby="emailHelp">

                                </div>
                                <div class="form-group">
                                    <label for="inputname">Mobile No.</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1"  placeholder="Type your Mobile Number" aria-describedby="emailHelp">

                                </div>
                                <div class="form-group">
                                    <label for="inputname">Full Address</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Type your Full Address" aria-describedby="emailHelp">

                                </div>
                                <div class="form-group">
                                    <label for="inputemail">Email address</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Type your Email Address" aria-describedby="emailHelp">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password Type Again">
                                </div>
